...
include('../functions/myfunctions.php');
    ...
    else if(isset($_POST['update_product_btn']))
    {
        ...
        original_price='$original_price',selling_price='$selling_price',qty='$qty',meta_title='$meta_title',meta_description='$meta_description',meta_keywords='$meta_keywords',status='$status',trending='$trending',image='$update_filename' WHERE id='$product_id'";
    ...
    else if(isset($_POST['delete_product']))
    {
        ...
        {
            // redirect("products.php","Something Went Wrongproduct");
            echo 500;
        }
    }
    else if(isset($_POST['update_order']))
    {
        ...
        $updateOrder="UPDATE orders SET status='$order_status' WHERE tracking_id='$track_no'";
        $updateOrder_exe=mysqli_query($con,$updateOrder);
